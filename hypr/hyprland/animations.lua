...
hl.animation({ leaf = "windowsMove", enabled = true, speed = 6, bezier = "standard", style = "slidevert 100%" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "standard", style = "slidevert 100%" })
